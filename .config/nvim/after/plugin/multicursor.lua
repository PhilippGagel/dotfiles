...
-- Add cursor in defined action range (i.e. gaip for all in paragraph
set("n", "ga", mc.addCursorOperator)

-- Add a cursor for all matches of cursor word/selection in the document.
set({ "n", "x" }, "<Leader>A", mc.matchAllAddCursors)
-- Add a cursor for all lines in selection
...
set({ "n", "x" }, "<Leader>]d", function() mc.diagnosticAddCursor(1) end)
set({ "n", "x" }, "<Leader>[d", function() mc.diagnosticAddCursor(-1) end)
set({ "n", "x" }, "<Leader>]s", function() mc.diagnosticSkipCursor(1) end)
set({ "n", "x" }, "<Leader>[S", function() mc.diagnosticSkipCursor(-1) end)
